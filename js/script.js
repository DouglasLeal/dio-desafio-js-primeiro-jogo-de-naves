let jogo = {}
let TECLA = { SETA_CIMA: 38, SETA_BAIXO: 40, ESPACO: 32 }
let velocidade = 5;
let posicaoY = parseInt(Math.random() * 400);
let podeAtirar = true;
let fimdejogo = false;
let pontos = 0;
let salvos = 0;
...
function disparo() {
    if (podeAtirar == true) {
        ...
        let tempoDisparo = window.setInterval(executaDisparo, 10);
    }
...
function reposicionaInimigo2() {
    let tempoColisao4 = window.setInterval(reposiciona, 5000);
